...
<head>
	...
	<title>backExercises</title>
	
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">

	<link rel="icon" type="image/png" href="images/icons/back.png"/>
...
?>
  ...
  <div class="container">
  <div id="imgbackExercises">
  <img src="images/backExercises.png" alt="backLeft" width="200" height="200">
  </div>
...
$sql = "SELECT Exercisename FROM exercise WHERE ExerciseType='Back' ORDER BY Exercisename";
