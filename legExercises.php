...
<head>
	...
	<title>legExercises</title>
	
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">

	<link rel="icon" type="image/png" href="images/icons/leg.png"/>
...
<input class="home_btn" type = "button" onclick = "window.location.href='http://localhost/herculeanFit/progressTracking.php';" class="btn btn-warning btn-lg" style="width:300px"; value="Progress Tracking"/>
  ...
  <div class="container">
  <div id="imglegExercises">
  <img src="images/legExercises.png" alt="chestLeft" width="200" height="200">
  </div>
...
$sql = "SELECT Exercisename FROM exercise WHERE ExerciseType='Legs' ORDER BY Exercisename";
